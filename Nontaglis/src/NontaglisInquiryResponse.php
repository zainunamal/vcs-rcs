...
/**
 * Description of NontaglisInquiryResponse
 *
 * @author yudo
 */
class NontaglisInquiryResponse extends CISO8583Parser
{
    ...
    public $nationalField = array();
    public $nationalFieldHeader = array();
    ...
    {
        //$splitter = new ElectricityNontaglisProtocolGeneric();
    ...
    private function SplitSecondPrivateData($stream)
    {
        ...
        if ($this->secondPrivateDataSingle) {
    ...
    public function getDataElementAmount()
    {
    ...
    public function ExtractDataElement()
    {
        if ($this->Parse()) {
            ...
            if (isset($this->dataElement['priv2'])) {
